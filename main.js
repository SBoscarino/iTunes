...
searchButton.addEventListener('click', function(evt){
  ...
  fetch(finalURL)
    ...
    .then(function(data){
      let contentGoesHere = '';
      // console.log(data); //this works!! Getting an array of 0.
...
//need to add concatination between words. Like, "backstreet boys" should be term=backstreet+boys"

  // <button>
  //     <span class="button play">Click me to play!</span>
  //     <span class="button pause">Pause!</span>
  // </button>
  //   <style>
  //   .button {
  //     background-image: url(${data.results[i].artworkUrl100});
  //     width: 70%;
  //     height: 70%;
  //     color:white;
  //     }
